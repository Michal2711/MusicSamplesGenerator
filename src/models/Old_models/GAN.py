from src.models.Old_models.Generator import Generator
from src.models.Old_models.Discriminator import Discriminator
from src.models.Old_models.Generator import Generator
...
class GAN(nn.Module):
    ...
    def init_generator(self):
        self.generator = Generator(self.height, self.width, 'mel', self.latent_dim).to(self.device)

    def init_discriminator(self):
        self.discriminator = Discriminator(self.height, self.width, 'mel').to(self.device)
